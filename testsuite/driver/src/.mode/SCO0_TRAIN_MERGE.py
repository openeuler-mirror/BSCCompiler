...
SCO0_TRAIN_MERGE = {
    "c2o": [
        MapleDriver(
            ...
            option="--O0 --patch-long-branch -fPIC --no-pie -std=gnu99 -lm -L${MAPLE_ROOT}/tools/gcc-linaro-7.5.0/aarch64-linux-gnu/libc/lib/",
    ...
    "compile": [
        MapleDriver(
            ...
            option="--O0 --patch-long-branch -fPIC --no-pie -flto -c",
            extra_opt="${SPEC_PARAM}"
        )
    ],
    "link": [
        MapleDriver(
            ...
            extra_opt="--O0 --patch-long-branch -fPIC --no-pie -flto ${SPEC_PARAM}"
        )
    ],
    "cp_data":[
        Shell(
