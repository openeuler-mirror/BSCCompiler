...
CO2_MUXED = {
	...
	Shell("${OUT_ROOT}/tools/gcc-linaro-7.5.0/bin/aarch64-linux-gnu-gcc -std=c99 -o ${APP}.o -c ${APP}.s")
    ],
    "link": [
        Shell("${OUT_ROOT}/tools/gcc-linaro-7.5.0/bin/aarch64-linux-gnu-gcc -std=gnu99 -no-pie *.o  -lm -o a.out")
    ],
    "run": [
        Shell(
