...
GCO2 = {
    "compile": [
        ...
        Maple(
            ...
            option={
                "dex2mpl": "-mplt=${OUT_ROOT}/target/product/maple_arm64/lib/host-x86_64-GCO2/libcore-all.mplt -anti-proguard-auto -dexcatch -gconly -gen-stringfieldvalue  -inlinefunclist=${OUT_ROOT}/target/product/public/lib/codetricks/profile.pv/to_inline.list -j=32 -j100 -litprofile=${OUT_ROOT}/target/product/public/lib/codetricks/profile.pv/meta.list -opt-switch-disable  -refine-catch -staticstringcheck",
    ...
    "run": [
        Mplsh(
            ...
            qemu_ld_lib=[
                ...
                "${OUT_ROOT}/target/product/maple_arm64/lib/host-x86_64-GCO2",
                "./"
            ],
