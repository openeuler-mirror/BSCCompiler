...
MAPLETI_ZTERP_PANDA = {
    ...
    "run": [
        Mplsh(
            ...
            mplsh="${OUT_ROOT}/target/product/maple_arm64/bin/mplsh -agentpath:${MAPLE_ROOT}/out/target/product/maple_arm64-clang-release/lib/host-x86_64-ZTERP/dummy-agent.so -pluginpath:${MAPLE_ROOT}/out/target/product/maple_arm64-clang-release/lib/host-x86_64-ZTERP/mapleti.so",
            garbage_collection_kind="RC",
            xbootclasspath="libcore-all.so ",
            infile="./MapleTiTest.bin:./MapleCode.so", #${CP}",
