...
#include <stddef.h>
int g_arr[] = {1,2,3,4,5};
int *g_p __attribute__((byte_count(20))) = g_arr;

int* (*func1)(int*, int*, int*)  __attribute__((byte_count(10,1,3), returns_byte_count(10)));
int* (*func2)(int*, int*, int*);
int* (*func3)(int*, int*, int*)  __attribute__((byte_count(10,1,3), returns_byte_count(10)));
int* (*func4)(int*, int*, int*)  __attribute__((byte_count(10,1,3)));
...
struct BB {
  int *i __attribute__((byte_count(32)));
};

__attribute__((byte_count(10,1,3), returns_byte_count(10)))
int *Test1(int* p, int *q, int *w) {
  return p;
}

__attribute__((byte_count(10,1), returns_byte_count(10)))
int *Test2(int* p, int *q, int *w) {
  return p;
}

__attribute__((byte_count(10,1,3)))
...
int Test() {
  ...
  int *q = array;
  int *w __attribute__((byte_count(20))) = array;
  int *x;
  struct BB b;
  struct BB *pb = &b;
  ...
  a.func1 = &Test5;  // CHECK: [[# @LINE ]] error:
  ...
  a.func1 = func7;  // CHECK: [[# @LINE ]] error:
  ...
  pa->func1 = &Test5;  // CHECK: [[# @LINE ]] error:
  ...
  pa->func1 = func7;  // CHECK: [[# @LINE ]] error:
...
struct CC {
  int* (*func1)(int*, int*, int*)  __attribute__((byte_count(10), byte_count(10,1,2,3), returns_byte_count(10)));
  int* (*func2)(int *, int*, int*)  __attribute__((byte_count(10)));
};

__attribute__((byte_count(10,1,2), byte_count(5,3)))
int Test_var(int *p, int *q, int *w) {
  int* (*func11)(int*, int*, int*)  __attribute__((byte_count(10), byte_count(10,1,2,3), returns_byte_count(10)));
  int* (*func12)(int*, int*, int*)  __attribute__((byte_count(10,1,2,3), returns_byte_count(10)));
