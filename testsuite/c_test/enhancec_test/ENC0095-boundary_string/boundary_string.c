...
char * const g_s = "12345";
char g_s_arr[10] = "12345";
char g_s_arr1[] = "12345";
char * const g_s_arr2[2] = {"12345", "123456"};
...
const struct A g_a = {{{1,2},{1,2}}, "12345678"};
const struct A g_a1 = {.j = "12345678"};
const struct B g_b = {1, 2.1, {{{1,2},{1,2}}, "123456789"}};
const struct B g_b_arr[2] = { {1, 2.1, { {{1,2},{1,2}}, "123456789"} }, 
                            {1, 2.2, { {{1,2},{1,2}}, "123456"} } };
const union U g_u = {.c="12345"};
const struct C g_c_arr[2] = { {1, { {{1,2},{1,2}}, "123456789"}, "1234567" },
