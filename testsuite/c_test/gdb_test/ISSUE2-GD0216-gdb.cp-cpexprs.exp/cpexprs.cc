...
public:
  ...
  { return foo_ + o.foo_; } // base::operator+

  base operator++ (void) // base::operator++
  { ++foo_; return *this; } // base::operator++

  base operator+=(base const& o) // base::operator+=
  { foo_ += o.foo_; return *this; } // base::operator+=
  ...
  { return foo_  << value; } // base::operator<<

  base operator<<= (int value) // base::operator<<=
  { foo_ <<= value; return *this; } // base::operator<<=
  ...
  { return this; } // base::opeartor->

  int operator->* (base const& b) const // base::operator->*
  {  return foo_ * b.foo_; } // base::operator->*
