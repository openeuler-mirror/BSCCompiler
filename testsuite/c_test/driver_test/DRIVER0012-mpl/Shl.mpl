...
LOC 2 5 3
func &printf implicit public used varargs extern (var %arg|4 <* u8>, ...) i32
LOC 2 1 5
func &main public () i32 {
  funcid 1
  funcinfo {
...
LOC 2 5 3
  callassigned &printf (conststr ptr "%d,%d\x0a", dread i32 %b_3_7, dread i32 %c_4_7) { dassign %retVar_3 0 }
LOC 2 6 3
