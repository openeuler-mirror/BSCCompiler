// Get the index of all characters of a to z
public class GetIndex {
  public static void main(String[] args) {
    String str = "Failures are the stepping stone to success.";
 
    // Get the index of all the characters of a to z
    ...
    // Get the indexOf method call
    System.out.println(" a b c d e f g h i ");
    System.out.println("-------------------");
    System.out.println(a + " " + b + " " + c + " " + d + " " +
                       e + " " + f + " " + g + " " + h + " " + i + "\n");

    System.out.println(" j k l m n o p q r ");
    System.out.println("-------------------");
