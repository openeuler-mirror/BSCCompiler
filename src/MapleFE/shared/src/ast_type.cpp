...
void ArrayTypeNode::Dump(unsigned ind) {
  DUMP0_NORETURN("array-TBD");
}
...
void FunctionTypeNode::Dump(unsigned ind) {
  DUMP0_NORETURN("functiontype-TBD");
}
