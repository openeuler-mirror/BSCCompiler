...
astgraph_init = [
        ...
        'case NK_Decl:        *mOs << EnumVal(DeclNode, DeclProp, Prop); break;',
        'case NK_PrimType:    *mOs << EnumVal(PrimTypeNode, TypeId, PrimType); break;',
        'case NK_BinOperator: *mOs << EnumVal(BinOperatorNode, OprId, OprId); break;',
