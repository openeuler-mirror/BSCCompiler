 ...
 */
#ifndef HIR2MPL_INCLUDE_COMMON_FE_FUNCTION_PHASE_RESULT_H
#define HIR2MPL_INCLUDE_COMMON_FE_FUNCTION_PHASE_RESULT_H
#include <map>
#include <string>
#include <list>
#include "types_def.h"
...
#endif  // HIR2MPL_INCLUDE_COMMON_FE_FUNCTION_PHASE_RESULT_H