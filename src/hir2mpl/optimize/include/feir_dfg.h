...
class FEIRDFG {
 public:
  FEIRDFG() = default;
  ~FEIRDFG() = default;
  void CalculateDefUseByUseDef(FEIRDefUseChain &mapDefUse, const FEIRUseDefChain &mapUseDef) const;
  void CalculateUseDefByDefUse(FEIRUseDefChain &mapUseDef, const FEIRDefUseChain &mapDefUse) const;
  void BuildFEIRUDDU();
