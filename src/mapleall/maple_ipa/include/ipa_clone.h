...
constexpr uint32 kNumOfImpExprBound = 2;
constexpr uint32 kNumOfCallSiteBound = 2;
...
class IpaClone : public AnalysisResult {
 public:
  ...
  bool CheckConstModel(MIRFunction *newFunc, uint32 paramIndex, std::vector<int64_t> &calleeValue, uint32 impSize);
