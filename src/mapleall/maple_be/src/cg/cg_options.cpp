...
maplecl::Option<bool> stackProtectorStrong({"--stack-protector-strong"},
                            ...
                            {cgCategory},
                            maplecl::DisableWith("--no-stack-protector-strong"));
...
maplecl::Option<bool> omitFramePointer({"--omit-frame-pointer"},
                                  " --omit-frame-pointer          \t do not use frame pointer \n"
                                  " --no-omit-frame-pointer\n",
                                  {cgCategory},
                                  maplecl::DisableWith("--no-omit-frame-pointer"));
...
maplecl::Option<bool> common({"--common"},
                        " --common           \t \n"
                        " --no-common\n",
                       {cgCategory},
                       maplecl::DisableWith("--no-common"));

maplecl::Option<bool> arm64Ilp32({"--arm64-ilp32"},
                            " --arm64-ilp32                 \tarm64 with a 32-bit ABI instead of a 64bit ABI\n"
                            " --no-arm64-ilp32\n",
                            {cgCategory},
                            maplecl::DisableWith("--no-arm64-ilp32"));
