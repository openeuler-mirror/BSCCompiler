...
constexpr X64reg intParmRegs[kNumIntParmRegs] = { R7, R6, R3, R2, R8, R9 };
constexpr X64reg intReturnRegs[kNumIntReturnRegs] = { R0, R3 };
constexpr X64reg floatParmRegs[kNumFloatParmRegs] = { V8, V9, V10, V11, V12, V13, V14, V15 };
constexpr X64reg floatReturnRegs[kNumFloatReturnRegs] = { V8, V9 };
