...
MAPLE_ANALYSIS_PHASE_REGISTER_CANSKIP(METailcall, tailcall)
...
MAPLE_TRANSFORM_PHASE_REGISTER_CANSKIP(MEGVN, gvn)
MAPLE_TRANSFORM_PHASE_REGISTER_CANSKIP(MESRA, sra)
...
MAPLE_TRANSFORM_PHASE_REGISTER_CANSKIP(MEOBJSize, objSize)
