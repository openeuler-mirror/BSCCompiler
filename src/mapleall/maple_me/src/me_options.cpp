...
maplecl::Option<bool> strictNaiverc({"--strict-naiverc"},
    ...
    {meCategory}, maplecl::DisableWith("--no-strict-naiverc"));
...
maplecl::Option<bool> calleeHasSideEffect({"--setCalleeHasSideEffect"},
    ...
    {meCategory}, maplecl::DisableWith("--no-setCalleeHasSideEffect"));
...
maplecl::Option<bool> ddaa({"--ddaa"},
    ...
    {meCategory}, maplecl::DisableWith("--no-ddaa"));
...
maplecl::Option<bool> regnativefunc({"--regnativefunc"},
    ...
    {meCategory}, maplecl::DisableWith("--no-regnativefunc"));
...
maplecl::Option<bool> warnemptynative({"--warnemptynative"},
    ...
    {meCategory}, maplecl::DisableWith("--no-warnemptynative"));
...
maplecl::Option<bool> dumpBefore({"--dump-before"},
    ...
    {meCategory}, maplecl::DisableWith("--no-dump-before"));
...
maplecl::Option<bool> dumpAfter({"--dump-after"},
    ...
    {meCategory},   maplecl::DisableWith("--no-dump-after"));

maplecl::Option<bool> realcheckcast({"--realcheckcast"},
    "  --realcheckcast\n"
    "  --no-realcheckcast\n",
    {meCategory}, maplecl::DisableWith("--no-realcheckcast"));
...
maplecl::Option<uint32_t> delrcpulimit({"--delrcpulimit"},
    "  --delrcpulimi               \tApply DELEGATERC optimization only for the first NUM PUs\n"
    "                              \t--delrcpulimit=NUM\n",
    {meCategory});
...
maplecl::Option<bool> ignoreipa({"--ignoreipa"},
    ...
    {meCategory}, maplecl::DisableWith("--no-ignoreipa"));
...
maplecl::Option<bool> enableHotColdSplit({"--enableHotColdSplit"},
    ...
    {meCategory}, maplecl::DisableWith("--no-enableHotColdSplit"));
...
maplecl::Option<bool> aggressiveABCO({"--aggressiveABCO"},
    ...
    {meCategory}, maplecl::DisableWith("--no-aggressiveABCO"));
...
maplecl::Option<bool> commonABCO({"--commonABCO"},
    ...
    {meCategory}, maplecl::DisableWith("--no-commonABCO"));
...
maplecl::Option<bool> conservativeABCO({"--conservativeABCO"},
    ...
    {meCategory}, maplecl::DisableWith("--no-conservativeABCO"));
...
maplecl::Option<bool> epreincluderef({"--epreincluderef"},
    ...
    {meCategory}, maplecl::DisableWith("--no-epreincluderef"));
...
maplecl::Option<bool> eprelocalrefvar({"--eprelocalrefvar"},
    ...
    {meCategory}, maplecl::DisableWith("--no-eprelocalrefvar"));
...
maplecl::Option<bool> eprelhsivar({"--eprelhsivar"},
    ...
    {meCategory},  maplecl::DisableWith("--no-eprelhsivar"));
...
maplecl::Option<bool> dsekeepref({"--dsekeepref"},
    ...
    {meCategory}, maplecl::DisableWith("--no-dsekeepref"));
...
maplecl::Option<bool> propbase({"--propbase"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propbase"));
...
maplecl::Option<bool> propiloadref({"--propiloadref"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propiloadref"));
...
maplecl::Option<bool> propglobalref({"--propglobalref"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propglobalref"));
...
maplecl::Option<bool> propfinaliloadref({"--propfinaliloadref"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propfinaliloadref"));
...
maplecl::Option<bool> propiloadrefnonparm({"--propiloadrefnonparm"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propiloadrefnonparm"));
...
maplecl::Option<bool> lessthrowalias({"--lessthrowalias"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lessthrowalias"));
...
maplecl::Option<bool> nodelegaterc({"--nodelegaterc"},
    ...
    {meCategory}, maplecl::DisableWith("--no-nodelegateerc"));
...
maplecl::Option<bool> nocondbasedrc({"--nocondbasedrc"},
    ...
    {meCategory},  maplecl::DisableWith("--no-nocondbasedrc"));

maplecl::Option<bool> subsumrc({"--subsumrc"},
    "  --subsumrc                  \tDelete decrements for localrefvars whose live range is just in tanother "
    "which point to the same obj.\n"
    "  --no-subsumrc               \tDisable subsumrc\n",
    {meCategory}, maplecl::DisableWith("--no-subsumrc"));
...
maplecl::Option<bool> performFSAA({"--performFSAA"},
    ...
    {meCategory}, maplecl::DisableWith("--no-performFSAA"));
...
maplecl::Option<bool> strengthreduction({"--strengthreduction"},
    ...
    {meCategory}, maplecl::DisableWith("--no-strengthreduction"));
...
maplecl::Option<bool> lftr({"--lftr"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lftr"));
...
maplecl::Option<bool> ivopts({"--ivopts"},
    ...
    {meCategory}, maplecl::DisableWith("--no-ivopts"));
...
maplecl::Option<bool> gvn({"--gvn"},
    ...
    {meCategory}, maplecl::DisableWith("--no-gvn"));
...
maplecl::Option<bool> checkcastopt({"--checkcastopt"},
    ...
    {meCategory}, maplecl::DisableWith("--no-checkcastopt"));
...
maplecl::Option<bool> parmtoptr({"--parmtoptr"},
    ...
    {meCategory}, maplecl::DisableWith("--no-parmtoptr"));
...
maplecl::Option<bool> nullcheckpre({"--nullcheckpre"},
    ...
    {meCategory}, maplecl::DisableWith("--no-nullcheckpre"));
...
maplecl::Option<bool> clinitpre({"--clinitpre"},
    ...
    {meCategory}, maplecl::DisableWith("--no-clinitpre"));
...
maplecl::Option<bool> dassignpre({"--dassignpre"},
    ...
    {meCategory}, maplecl::DisableWith("--no-dassignpre"));
...
maplecl::Option<bool> assign2finalpre({"--assign2finalpre"},
    ...
    {meCategory}, maplecl::DisableWith("--no-assign2finalpre"));
...
maplecl::Option<bool> propduringbuild({"--propduringbuild"},
    ...
    {meCategory}, maplecl::DisableWith("--no-propduringbuild"));
...
maplecl::Option<bool> lprespeculate({"--lprespeculate"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lprespeculate"));
...
maplecl::Option<bool> lpre4address({"--lpre4address"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lpre4address"));
...
maplecl::Option<bool> lpre4largeint({"--lpre4largeint"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lpre4largeint"));
...
maplecl::Option<bool> spillatcatch({"--spillatcatch"},
    ...
    {meCategory}, maplecl::DisableWith("--no-spillatcatch"));
...
maplecl::Option<bool> placementrc({"--placementrc"},
    ...
    {meCategory}, maplecl::DisableWith("--no-placementrc"));
...
maplecl::Option<bool> lazydecouple({"--lazydecouple"},
    ...
    {meCategory}, maplecl::DisableWith("--no-lazydecouple"));
...
maplecl::Option<bool> mergestmts({"--mergestmts"},
    ...
    {meCategory}, maplecl::DisableWith("--no-mergestmts"));
...
maplecl::Option<bool> ignoreInferredRetType({"--ignore-inferred-ret-type"},
    ...
    {meCategory}, maplecl::DisableWith("--no-ignore-inferred-ret-type"));

maplecl::Option<bool> meverify({"--meverify"},
    "  --meverify                  \tenable meverify features\n",
    {meCategory}, maplecl::DisableWith("--no-meverify"));
...
maplecl::Option<bool> loopvec({"--loopvec"},
    ...
    {meCategory}, maplecl::DisableWith("--no-loopvec"));
...
maplecl::Option<bool> seqvec({"--seqvec"},
    ...
    {meCategory}, maplecl::DisableWith("--no-seqvec"));
...
maplecl::Option<bool> layoutwithpredict({"--layoutwithpredict"},
    ...
    {meCategory}, maplecl::DisableWith("--no-layoutwithpredict"));

maplecl::Option<bool> layoutColdPath({"--layout-cold-path"},
    "  --layout-cold-path          \tEnable layouting cold blocks (such as unlikely) out of hot path\n"
    "  --no-layout-cold-path       \tDisable layouting cold blocks (such as unlikely) out of hot path\n",
    {meCategory}, maplecl::DisableWith("--no-layout-cold-path"));
...
maplecl::Option<bool> toolonly({"--toolonly"},
    "  --toolonly                  \n"
    "  --no-toolonly               \n",
    {meCategory}, maplecl::DisableWith("--no-toolonly"));

maplecl::Option<bool> toolstrict({"--toolstrict"},
    "  --toolstrict                \n"
    "  --no-toolstrict             \n",
    {meCategory}, maplecl::DisableWith("--no-toolstrict"));

maplecl::Option<bool> skipvirtual({"--skipvirtual"},
    "  --skipvirtual               \n"
    "  --no-skipvirtual            \n",
    {meCategory}, maplecl::DisableWith("--no-skipvirtual"));
...
maplecl::Option<bool> unifyrets({"--unifyrets"},
    ...
    {meCategory}, maplecl::DisableWith("--no-unifyrets"));

maplecl::Option<bool> lfo({"--lfo"},
    "  --lfo                       \tEnable LFO framework\n"
    "  --no-lfo                    \tDisable LFO framework\n",
    {meCategory}, maplecl::DisableWith("--no-lfo"));
...
maplecl::Option<bool> epreUseProfile({"--epreuseprofile"},
    ...
    {meCategory}, maplecl::DisableWith("--no-epreuseprofile"));
