...
class ValueRangePropagation {
 ...
 private:
  ...
  bool CanComputeLoopIndVar(const MeExpr &phiLHS, MeExpr &expr, int64 &constant) const;
  ...
  std::unique_ptr<ValueRange> ZeroIsInRange(const ValueRange &valueRange) const;
